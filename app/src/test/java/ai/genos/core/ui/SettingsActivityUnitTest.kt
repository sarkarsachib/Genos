...
class SettingsActivityUnitTest {
    ...
    @Before
    fun setUp() {
        activity = Robolectric.buildActivity(SettingsActivity::class.java)
            .create()
            .start()
            .resume()
            .get()
    ...
    fun `activity can be recreated`() {
        ...
        val newActivity = Robolectric.buildActivity(SettingsActivity::class.java)
            .create()
            .get()
    ...
    @Test
    fun `multiple activity instances can coexist`() {
        val activity1 = Robolectric.buildActivity(SettingsActivity::class.java).create().get()
        val activity2 = Robolectric.buildActivity(SettingsActivity::class.java).create().get()
