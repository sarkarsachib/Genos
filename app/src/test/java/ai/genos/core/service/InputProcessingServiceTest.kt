...
class InputProcessingServiceTest {
    ...
    private lateinit var service: InputProcessingService
    private lateinit var controller: ServiceController<InputProcessingService>

    @Before
    fun setUp() {
        controller = Robolectric.buildService(InputProcessingService::class.java)
